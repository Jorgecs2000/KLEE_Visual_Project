...
9:                                                ; preds = %0
  ...
  br i1 %11, label %12, label %14, !dbg !38

12:                                               ; preds = %9
  store i32* %3, i32** @n, align 8, !dbg !39
  %13 = load i32*, i32** @n, align 8, !dbg !41
  store i32* %13, i32** @p, align 8, !dbg !42
  br label %16, !dbg !43

14:                                               ; preds = %9
  store i32* %3, i32** @y, align 8, !dbg !44
  %15 = load i32*, i32** @y, align 8, !dbg !46
  store i32* %15, i32** @n, align 8, !dbg !47
  br label %16
...
!45 = distinct !DILexicalBlock(scope: !35, file: !3, line: 22, column: 5)
!46 = !DILocation(line: 24, column: 8, scope: !45)
!47 = !DILocation(line: 24, column: 7, scope: !45)
