...
define dso_local i32 @main() #0 !dbg !7 {
  ...
  %8 = icmp slt i32 %7, 5, !dbg !24
  br i1 %8, label %9, label %10, !dbg !25

9:                                                ; preds = %0
  store i32* %4, i32** %5, align 8, !dbg !26
  br label %11, !dbg !28

10:                                               ; preds = %0
  store i32* %4, i32** %2, align 8, !dbg !29
  br label %11
...
!24 = !DILocation(line: 10, column: 7, scope: !23)
!25 = !DILocation(line: 10, column: 6, scope: !7)
!26 = !DILocation(line: 12, column: 6, scope: !27)
!27 = distinct !DILexicalBlock(scope: !23, file: !1, line: 11, column: 3)
!28 = !DILocation(line: 13, column: 3, scope: !27)
!29 = !DILocation(line: 15, column: 6, scope: !30)
!30 = distinct !DILexicalBlock(scope: !23, file: !1, line: 14, column: 3)
!31 = !DILocation(line: 18, column: 3, scope: !7)
