...
@b2 = common dso_local global i32* null, align 8, !dbg !10

; Function Attrs: noinline nounwind uwtable
define dso_local i32 @main() #0 !dbg !19 {
  %1 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  store i32* getelementptr inbounds ([5 x i32], [5 x i32]* @c, i64 0, i64 0), i32** @b, align 8, !dbg !22
  %2 = load i32*, i32** @b, align 8, !dbg !23
  store i32* %2, i32** @b2, align 8, !dbg !24
  ret i32 0, !dbg !25
}
...
!1 = distinct !DIGlobalVariable(name: "c", scope: !2, file: !3, line: 4, type: !12, isLocal: false, isDefinition: true)
...
!11 = distinct !DIGlobalVariable(name: "b2", scope: !2, file: !3, line: 5, type: !8, isLocal: false, isDefinition: true)
!12 = !DICompositeType(tag: DW_TAG_array_type, baseType: !9, size: 160, elements: !13)
!13 = !{!14}
...
!21 = !{!9}
!22 = !DILocation(line: 7, column: 2, scope: !19)
!23 = !DILocation(line: 8, column: 4, scope: !19)
!24 = !DILocation(line: 8, column: 3, scope: !19)
!25 = !DILocation(line: 11, column: 3, scope: !19)
