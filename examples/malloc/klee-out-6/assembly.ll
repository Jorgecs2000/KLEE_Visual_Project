...
define dso_local i32 @main() #0 !dbg !13 {
  ...
  %4 = load i32, i32* %3, align 4, !dbg !21
  %5 = sext i32 %4 to i64, !dbg !21
  %6 = mul i64 %5, 4, !dbg !22
  %7 = call noalias i8* @malloc(i64 %6) #3, !dbg !23
  %8 = bitcast i8* %7 to i32*, !dbg !24
  store i32* %8, i32** @n, align 8, !dbg !25
  %9 = load i32*, i32** @n, align 8, !dbg !26
  store i32* %9, i32** %2, align 8, !dbg !27
  ret i32 0, !dbg !28
}
...
!15 = !{!7}
!16 = !DILocalVariable(name: "p", scope: !13, file: !3, line: 5, type: !6)
!17 = !DILocation(line: 5, column: 6, scope: !13)
!18 = !DILocalVariable(name: "m", scope: !13, file: !3, line: 6, type: !7)
!19 = !DILocation(line: 6, column: 5, scope: !13)
!20 = !DILocation(line: 7, column: 4, scope: !13)
!21 = !DILocation(line: 8, column: 18, scope: !13)
!22 = !DILocation(line: 8, column: 19, scope: !13)
!23 = !DILocation(line: 8, column: 11, scope: !13)
!24 = !DILocation(line: 8, column: 5, scope: !13)
!25 = !DILocation(line: 8, column: 4, scope: !13)
!26 = !DILocation(line: 9, column: 5, scope: !13)
!27 = !DILocation(line: 9, column: 4, scope: !13)
!28 = !DILocation(line: 10, column: 3, scope: !13)
