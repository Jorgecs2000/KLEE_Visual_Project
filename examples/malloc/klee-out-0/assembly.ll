...
define dso_local i32 @main() #0 !dbg !10 {
  ...
  %6 = mul i64 %5, 1, !dbg !19
  %7 = call noalias i8* @malloc(i64 %6) #3, !dbg !20
  store i8* %7, i8** %3, align 8, !dbg !21
  ret i32 0, !dbg !22
}
...
!14 = !DILocalVariable(name: "n", scope: !10, file: !1, line: 5, type: !13)
!15 = !DILocation(line: 5, column: 7, scope: !10)
!16 = !DILocalVariable(name: "s", scope: !10, file: !1, line: 6, type: !4)
!17 = !DILocation(line: 6, column: 9, scope: !10)
!18 = !DILocation(line: 7, column: 19, scope: !10)
!19 = !DILocation(line: 7, column: 20, scope: !10)
!20 = !DILocation(line: 7, column: 12, scope: !10)
!21 = !DILocation(line: 7, column: 4, scope: !10)
!22 = !DILocation(line: 12, column: 3, scope: !10)
