...
define dso_local i32 @main() #0 !dbg !10 {
  ...
  %6 = mul i64 %5, 4, !dbg !18
  %7 = call noalias i8* @malloc(i64 %6) #3, !dbg !19
  %8 = bitcast i8* %7 to i32*, !dbg !20
  store i32* %8, i32** %2, align 8, !dbg !21
  ret i32 0, !dbg !22
}
...
!17 = !DILocation(line: 6, column: 18, scope: !10)
!18 = !DILocation(line: 6, column: 19, scope: !10)
!19 = !DILocation(line: 6, column: 11, scope: !10)
!20 = !DILocation(line: 6, column: 5, scope: !10)
!21 = !DILocation(line: 6, column: 4, scope: !10)
!22 = !DILocation(line: 9, column: 3, scope: !10)
