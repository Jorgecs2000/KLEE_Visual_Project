...
define dso_local i32 @main() #0 !dbg !26 {
  ...
  call void @klee_make_symbolic(i8* bitcast (i32** @p to i8*), i64 8, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)), !dbg !33
  %4 = load i32, i32* %2, align 4, !dbg !34
  %5 = call i32 @ejem1(i32 %4), !dbg !35
  ret i32 %5, !dbg !36
}
...
!33 = !DILocation(line: 22, column: 3, scope: !26)
!34 = !DILocation(line: 23, column: 16, scope: !26)
!35 = !DILocation(line: 23, column: 10, scope: !26)
!36 = !DILocation(line: 23, column: 3, scope: !26)
